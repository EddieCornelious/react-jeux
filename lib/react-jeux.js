...
var _defaultMapStateToProps = _interopRequireDefault(__webpack_require__(/*! ./defaultMapStateToProps.js */ "./src/defaultMapStateToProps.js"));

var _defaultMapDispatchToProps = _interopRequireDefault(__webpack_require__(/*! ./defaultMapDispatchToProps.js */ "./src/defaultMapDispatchToProps.js"));

var _shallowEqual = _interopRequireDefault(__webpack_require__(/*! ./shallowEqual.js */ "./src/shallowEqual.js"));

var _mergeObjs = _interopRequireDefault(__webpack_require__(/*! ./mergeObjs.js */ "./src/mergeObjs.js"));
...
function connect() {
  var mapStateToProps = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _defaultMapStateToProps.default;
  var mapDispatchToProps = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _defaultMapDispatchToProps.default;
      ...
      function (_Component) {
        ...
        _createClass(WrapperComponent, [{
          ...
          value: function initSubscribe() {
            ...
            if (!this.unsubscribe) {
              this.unsubscribe = store.subscribe(function (newState) {
                return ctx.setState({
                  storeState: newState
                });
              });
          ...
          value: function updateStateProps() {
            ...
            if ((0, _shallowEqual.default)(nextStateProps, this.stateProps)) {
              return false;
            }
          ...
          value: function componentWillReceiveProps(nextProps) {
            this.propsChanged = !(0, _shallowEqual.default)(nextProps, this.props);
          }
        }, {
          ...
          value: function updateDispatchProps() {
            ...
            if ((0, _shallowEqual.default)(nextDispatchProps, this.dispatchProps)) {
              return false;
            }
          ...
          value: function render() {
            ...
            if (this.firstCycle) {
              this.renderedEle = (0, _react.createElement)(componentToConnectToStore, (0, _mergeObjs.default)(this.stateProps, this.dispatchProps, this.props));
              this.firstCycle = false;
              return this.renderedEle;
            }

            this.propsChanged = !(0, _shallowEqual.default)(this.propsBeforeRender, this.props);
...
var _connect = _interopRequireDefault(__webpack_require__(/*! ./connect.js */ "./src/connect.js"));
