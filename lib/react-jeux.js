...
var _mergeObjects = __webpack_require__(/*! ./mergeObjects.js */ "./src/mergeObjects.js");
    ...
    return (
      ...
      function (_Component) {
        ...
        function WrapperComponent(props) {
          ...
          _this.renderedEle = (0, _react.createElement)(componentToConnectToStore, (0, _mergeObjects2["default"])(_this.stateProps, _this.dispatchProps, _this.props));
          return _this;
        }
        ...
        _createClass(WrapperComponent, [{
          ...
          key: "shouldTryAndUpdateStateProps",
          value: function shouldTryAndUpdateStateProps() {
            return this.storeHasChanged || this.propsHaveChanged && stateMapperDependsOnProps;
          }
        }, {
          key: "shouldTryAndUpdateDispatchProps",
          value: function shouldTryAndUpdateDispatchProps() {
            return this.propsHaveChanged && dispatchMapperDependsOnProps;
          }
        }, {
          key: "maybeUpdateStateProps",
          value: function maybeUpdateStateProps() {
          ...
          value: function updateStateProps(newStateProps) {
          ...
          key: "maybeUpdateDispatchProps",
          value: function maybeUpdateDispatchProps() {
          ...
          value: function updateDispatchProps(newDispatchProps) {
          ...
          value: function render() {
            ...
            this.propsHaveChanged = !(0, _shallowEqual2["default"])(this.propsBeforeRender, this.props);
            ...
            if (this.propsHaveChanged || stateMapperChanged || dispatchMapperChanged) {
              this.renderedEle = (0, _react.createElement)(componentToConnectToStore, (0, _mergeObjects2["default"])(this.stateProps, this.dispatchProps, this.props));
            }
...
function mergeObjects(stateProps, dispatchProps, ownProps) {
